...
```{r corn yield download, message=FALSE, results='hide'}
...
## Extract Winneshiek County corn yields, fit a linear time trend, make a plot.
...
## Fitting a quadratic time trend (i.e., year + year^2) and making a plot. 
...
## Time Series: Analyzing the relationship between temperature and yields for the Winneshiek County time series.
...
## Cross-Section: Analyzing the relationship between temperature and yield across all counties in 2018. 
...
## Panel: Plot comparing actual and fitted yields and interpret the results of your model.

```{r cornplot, warning=FALSE, message=FALSE}
...
## Soybeans: Time series plot

```{r cornyield download, message=FALSE, results='hide'}
# set our API key with NASS
nassqs_auth(key = "693A4922-893D-3AF4-A23B-6288B220EC7E")

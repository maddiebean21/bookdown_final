...
In this assignment, I used the R package 'sf' and other R packages to explore spatial operations in R markdown. I used data from LAGOS database to look at clean lake data in Minnesota, Illinois, and Iowa. 
